...
import {
    AppointmentsRoutes,
    appointmentsRoutes,
} from './pages/appointments/appointments.routes'
...
import {
    CauseListRoutes,
    causeListRoutes,
} from './pages/cause-list/cause-list.routes'
...
import {
    DocumentsRoutes,
    documentsRoutes,
} from './pages/documents/documents.routes'
import {
    FeedbackRoutes,
    feedbackRoutes,
...
import {
    OrganizationRoutes,
    organizationRoutes,
} from './pages/organization/organization.routes'
import {
    PrivacyPolicyRoutes,
    privacyPolicyRoutes,
...
import {
    ReferralRoutes,
    referralRoutes,
} from './pages/referral/referral.routes'
import {
    RoleSelectionRoutes,
    roleSelectionRoutes,
...
import {
    SettingsRoutes,
    settingsRoutes,
} from './pages/settings/settings.routes'
